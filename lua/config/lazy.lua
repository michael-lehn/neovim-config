...
require("lazy").setup({
    ...
    -- automatically check for plugin updates and install them
    checker = {
	enabled = true,        -- enables the plugin update checker
	frequency = 86400,     -- check for updates every day (in seconds)
